<footer class="page-footer orange">
        ...
        <div class="row">
            ...
            <div class="right">
                ...
                <ul>
                    ...
                    <li><a class="white-text" href="?acerca">Acerca de</a></li>
                    <li><a class="white-text" href="?contacto">Contacto</a></li>
                    <li><a class="white-text" href="?cookies">Cookies</a></li>
                </ul>
            </div>
    ...
    <div class="footer-copyright">
      <div class="container">
          <a href="https://github.com/Cadiducho/Cadiducho.com/blob/master/LICENSE" class="white-text">©</a> 2015 Cadiducho
      </div>
    </div>
</footer>